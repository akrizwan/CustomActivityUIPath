...
{
    [Activity]
    [Designer(typeof(CSharpCodingDesigner))]
    public class CSharpCoding:NativeActivity
    {
        ...
        [RequiredArgument]
        [DefaultValue(null)]
        [Editor(typeof(ScriptPropertyEditor), typeof(System.Activities.Presentation.PropertyEditing.DialogPropertyValueEditor))]
        ...
        protected override void Execute(NativeActivityContext context)
        {
            ...
            CompilerResults _compilerResults = _codeDomProvider.CompileAssemblyFromSource(_compilerParameters, Script.Get(context));
            ...
            var pattern = @" [^ ]*[ \s\t]*\(";
            var matches = Regex.Matches(Script.Get(context), pattern);
            Match m = matches[0];
